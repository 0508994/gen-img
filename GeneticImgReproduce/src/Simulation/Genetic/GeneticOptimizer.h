...
public:
    ...
    GeneticOptimizer(std::size_t popSize, double transMutChance, double rotMutChance, std::size_t elitismn);

public:
    void PrepareGA(const sf::Image& origImage, Uint8 threshold, std::size_t minLineLen, std::size_t maxLineLen);
